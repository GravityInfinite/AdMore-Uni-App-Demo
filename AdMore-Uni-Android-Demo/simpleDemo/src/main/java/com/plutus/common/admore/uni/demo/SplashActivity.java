...
public class SplashActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private void allPermissionGranted() {
        ...
        if (isColdStart) {
            ...
            AMSDK.preInit(AdmoreConstant.APP_ID, AdmoreConstant.APP_KEY, AdmoreConstant.TEST_USER_ID, new AMSDKInitListener() {
                @Override
...
//                @Override
//                public void run() {
//                    startActivity(new Intent(SplashActivity.this, PandoraEntry.class));
//                }
//            }, 5000);
//            return;
        }
